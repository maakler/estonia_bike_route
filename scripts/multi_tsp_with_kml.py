...
def main():
    ...
    try:
        ...
        print("Error: 'Tartu' not in city_names!")
        return
    try:
        tallinn_idx = city_names.index("Tallinn")
    except ValueError:
        print("Error: 'Tallinn' not in city_names!")
        return
    ...
    if route_indices_tt:
        ...
        generate_kml(
            ...
            output_file="Tartu_Tartu.kml",
            route_label="Tartu -> Tartu"
        )
